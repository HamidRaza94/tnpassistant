...
<body>
	...
	<section id="section-nav">
		<div id="navbar" class="index-div">
			...
			<div id="nav">
				<div id="nav_item">
					<a class="nav_item_content" href="#" style="background-color: white; color: black !important;">HOME</a>
					<a class="nav_item_content" href="#">NEWS</a>
					<a class="nav_item_content" href="http://localhost:8080/tnp/forum.jsp">FORUM</a>
					<a class="nav_item_content" href="http://localhost:8080/tnp/contact.html">CONTACT</a>
				</div>
			</div>
		</div>
	</section>
